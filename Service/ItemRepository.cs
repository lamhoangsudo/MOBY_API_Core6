...
namespace MOBY_API_Core6.Service
{
    public class ItemRepository
    {
        ...
        public async Task<List<BriefItem>?> GetAllShareFree(int pageNumber, int pageSize)
        {
            int itemsToSkip = (pageNumber - 1) * pageSize;
            var query = _context.BriefItems
        ...
        public async Task<List<BriefItem>?> GetAllShareNearYou(string city, int pageNumber, int pageSize, int userID)
        {
            int itemsToSkip = (pageNumber - 1) * pageSize;
            var query = _context.BriefItems
        ...
        public async Task<List<BriefItem>?> GetItemDynamicFilters(DynamicFilterItemVM dynamicFilterVM)
        {
        ...
        public async Task<List<BriefItem>?> GetListRecommend(int userID, int pageNumber, int pageSize)
        {
        ...
        public async Task<List<BriefItem>?> GetListRecommendByBaby(int babyID, int userID, int pageNumber, int pageSize, bool age, bool weight, bool height)
        {
